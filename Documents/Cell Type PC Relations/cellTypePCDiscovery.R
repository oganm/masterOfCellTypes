...
for (i in 1:len(ourGenes)){
    tryCatch({
        ...
        colnames(toHeat) = c('1PC1','1PC2','1PC3','1PC4','2PC1','2PC2','2PC3','2PC4')
        toHeat= cor(toHeat)
        svg(paste0('Documents/Cell Type PC Relations/',names(ourGenes)[i],'/PC cors.svg'))
        ...
        svg(paste0('Documents/Cell Type PC Relations/',names(ourGenes)[i],'/pH.svg'))
        ...
        toHeat = data.frame(SCZ.BP = phScz, BP = phBp)
        svg(paste0('Documents/Cell Type PC Relations/',names(ourGenes)[i],'/age.svg'))
        ...
        toHeat = data.frame(SCZ.BP = phScz, BP = phBp)
        svg(paste0('Documents/Cell Type PC Relations/',names(ourGenes)[i],'/postMort.svg'))
...
svg('Documents/Cell Type PC Relations/Microglia - ignore stim.svg')
...
svg('Documents/Cell Type PC Relations/Microglia - just stim.svg')
